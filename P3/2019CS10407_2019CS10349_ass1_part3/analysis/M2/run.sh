...
do  
    printf "`./m2_output "$1" "$i"` `python3 compare.py "M2output/out_with_factor_"$i"0000.txt" M2output/std_out.txt` `echo "$i"`\n" 
done > err.txt

printf "`./m1_output "$1" 1` `python3 compare.py "M2output/out_with_factor_1.000000.txt" M2output/std_out.txt` `echo 1.00`\n" >> err.txt 
